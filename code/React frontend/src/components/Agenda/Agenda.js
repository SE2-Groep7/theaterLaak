  ...
  async function getShows(givenShows) {
    ...
    try {
      ...
      const filePromises = arrayA.map(async element => {
        ...
        return {
          ...element, file: URL.createObjectURL(new Blob([fileResponse.data]))
        };
      });
    ...
    <main>
      <div class="Agenda">
        ...
        <div id="AgendaWrapper">
          <div class="AgendaContentBox">
            <div class="AgendaContentWrapper">
              <h2 class="AgendaContentTitle">Mijn Voorstellingen</h2>
              <div class="AgendaRoundCorners">
                <div class="AgendaScrollbar" id="style-4">
